...
public class DepartamentoService {
    ...
    @Autowired
    public DepartamentoService(DepartamentoRepository departamentoRepository, AsignaturaRepository asignaturaRepository, ProfesorRepository profesorRepository) {
    ...
    public Departamento assignProfesorToDepartamento(Long ProfesorId, Long DepartamentoId){
        Profesor profesor = (Profesor) profesorRepository.findById(ProfesorId);
        Departamento departamento = findDepartamentoById(DepartamentoId);
